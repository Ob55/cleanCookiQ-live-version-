        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/auth/register">
              <Button size="sm" className="bg-primary text-primary-foreground hover:bg-emerald-light">
                Join the Platform
              </Button>
            </Link>
          </div>
          ...
          <div className="md:hidden border-t border-border bg-background p-4 space-y-3">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <Link to="/auth/register" className="flex-1">
                <Button size="sm" className="w-full bg-primary text-primary-foreground">Join</Button>
              </Link>
            </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Orchestrating Kenya's transition to clean institutional cooking.
              </p>
            </div>
            <div>
